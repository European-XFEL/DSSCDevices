#ifndef F2BCHIPINTERFACE_H
#define F2BCHIPINTERFACE_H

#include "CHIPInterface.h"

namespace SuS {

class F2BCHIPInterface : public CHIPInterface
{
  public:
    F2BCHIPInterface();
    F2BCHIPInterface(CHIPFullConfig *fullConfig);
