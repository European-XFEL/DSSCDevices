...
namespace karabo {
                               ...
                               const karabo::xms::InputChannel::MetaData& meta) //find data for data source
    {
       ...
       m_endTrainId = meta.getTimestamp().getTrainId();
       m_receivedTrains++;
       ...
       processTrain(data.get<util::NDArray>("image.data"),
                    ...
                    meta.getTimestamp().getTrainId());

    }


    void DsscProcessor::processTrain(const karabo::util::NDArray& data, const karabo::util::NDArray& cellId, unsigned long long trainId) {
...
#pragma omp parallel for
    ...
    void DsscProcessor::updatePreviewData(const karabo::util::Hash& data, unsigned long long trainId) {
        //
