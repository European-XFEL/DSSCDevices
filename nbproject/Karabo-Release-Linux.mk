...
${OBJECTDIR}/_ext/153712117/DsscDependencies.o: ../DsscDependencies/DsscDependencies/src/DsscDependencies.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DF2IO -DHAVE_HDF5 -I${KARABO}/include -I${KARABO}/installed/DsscDependencies/DsscDependencies/src/libUtils/ -I${KARABO}/extern/include/hdf5 -I${KARABO}/installed/DsscDependencies/DsscDependencies/src/libCHIPInterface/ -I${KARABO}/installed/DsscDependencies/DsscDependencies/src/libConfigReg/ -I${KARABO}/installed/DsscDependencies/DsscDependencies/src/libDsscHdf5/ -I${KARABO}/installed/DsscDependencies/DsscDependencies/src/libPPT/ -I${KARABO}/installed/DsscDependencies/DsscDependencies/src/libPPTDataReceiver -I${KARABO}/installed/DsscDependencies/DsscDependencies/src/libSequencer/ -I${KARABO}/extern/dssc_minuit/include -I${KARABO}/extern/include/dssc -I${KARABO}/extern/include `pkg-config --cflags karaboDependencies` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/153712117/DsscDependencies.o ../DsscDependencies/DsscDependencies/src/DsscDependencies.cpp
